...
class TemplateGuesserTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGuessTemplateName()
    {
        ...
        $this->assertEquals('FooBundle:Foo:email.contactAdvertiser.html.twig', (string) $templateReference);;
    }
    ...
    public function testGuessTemplateNameWithParentBundle()
    {
        ...
        $this->assertEquals('FooBundle:Bar:email.contactAdvertiser.html.twig', (string) $templateReference);;
    }
    ...
    public function testGuessTemplateNameWithCascadingParentBundle()
    {
        ...
        $this->assertEquals('FooBundle:FooBar:email.contactAdvertiser.html.twig', (string) $templateReference);;
    }
