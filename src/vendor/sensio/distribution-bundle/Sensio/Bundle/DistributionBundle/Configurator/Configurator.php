...
class Configurator
{
    ...
    public function __construct($kernelDir)
    {
        ...
        $this->filename = $kernelDir.'/config/parameters_prod.yml';
    ...
    /**
     * Writes parameters to parameters_prod.yml or temporary in the cache directory.
     *
     * @return boolean
     */
    ...
    {
        return $this->kernelDir.'/cache/parameters_prod.yml';
    }
}
