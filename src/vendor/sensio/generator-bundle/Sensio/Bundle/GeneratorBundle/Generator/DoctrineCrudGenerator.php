...
class DoctrineCrudGenerator extends Generator
{
    ...
    /**
     * Generates the email.contactAdvertiser.html.twig template in the final bundle.
     *
     * @param string $dir The path to the folder that hosts templates in the bundle
     */
    protected function generateIndexView($dir)
    {
        $this->renderFile('crud/views/email.contactAdvertiser.html.twig.twig', $dir.'/email.contactAdvertiser.html.twig', array(
            'bundle'            => $this->bundle->getName(),
            'entity'            => $this->entity,
