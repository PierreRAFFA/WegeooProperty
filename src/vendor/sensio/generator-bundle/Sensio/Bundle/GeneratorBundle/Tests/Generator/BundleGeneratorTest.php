...
class BundleGeneratorTest extends GeneratorTest
{
    public function testGenerateYaml()
    {
        ...
        $files = array(
            ...
            'Resources/views/Default/email.contactAdvertiser.html.twig',
        ...
        $content = file_get_contents($this->tmpDir.'/Foo/BarBundle/Resources/views/Default/email.contactAdvertiser.html.twig');
